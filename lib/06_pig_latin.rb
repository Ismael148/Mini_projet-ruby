#definition d'une methode pour traduire un caractère donnée
def translate(sent)
    sent = sent.downcase
    vowels = ['a', 'e', 'i', 'o', 'u']
    words = sent.split(' ')
    ...
    if vowels.include? word[0]
        ...
        word.each_with_index do |char, index|
            if vowels.include? char
                # gérer les mots commençant par «qu»
                ...
                # gérer les mots avec 'qu' au milieu
        ...
        # traduction de mots consonantiques sans qu
        if not qu
